 ...
 * </pre>
 */
public class BestGZIPOutputStream extends DeflaterOutputStream {

    static private final int BUF_SIZE = 8192;
    private long tbytes = 0L;
    /**
     ...
     * the given stream.
     */
    public BestGZIPOutputStream(OutputStream os) throws IOException {
     ...
     * @since 1.7
     */
    public BestGZIPOutputStream(OutputStream os, boolean syncFlush) throws IOException {
     ...
     */
    public BestGZIPOutputStream(OutputStream os, int bufferSize) throws IOException {
