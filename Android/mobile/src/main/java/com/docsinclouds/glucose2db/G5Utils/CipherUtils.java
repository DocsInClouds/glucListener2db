...
//        return encryptBytes(plainText, keyBytes);
        Log.wtf(TAG, "encryptBytes not implemented");
        return null;
    }
    ...
    public static byte[] decryptBytes(byte[] cipherData) {
        ...
        Log.wtf(TAG, "decryptBytes not implemented");
        return null;
    }
    ...
    public static byte[] decryptStringToBytes(String cipherData) {
        ...
        if ((decryptedBytes.length > 8)
            ...
            decryptedBytes = HelperClass.decompressBytesToBytes(decryptedBytes);
        }
    ...
    public static String compressEncryptString(String plainText) {
        return Base64.encodeToString(CipherUtils.encryptBytes(HelperClass.compressStringToBytes(plainText))
                , Base64.NO_WRAP);
    }

    public static String compressEncryptBytes(byte[] plainText) {
        return Base64.encodeToString(CipherUtils.encryptBytes(HelperClass.compressBytesToBytes(plainText))
                , Base64.NO_WRAP);
    }
