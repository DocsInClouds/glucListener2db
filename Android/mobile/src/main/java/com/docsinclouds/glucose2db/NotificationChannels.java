...
public class NotificationChannels {
    ...
    private static synchronized void initialize_name_map() {
        if (map != null) return;
        map = new HashMap<>();
        map.put(LOW_BRIDGE_BATTERY_CHANNEL, BackgroundClass.getAppContext().getString(R.string.low_bridge_battery));
        map.put(LOW_TRANSMITTER_BATTERY_CHANNEL, BackgroundClass.getAppContext().getString(R.string.transmitter_battery));
        map.put(NIGHTSCOUT_UPLOADER_CHANNEL, "Nightscout");
        map.put(PARAKEET_STATUS_CHANNEL, BackgroundClass.getAppContext().getString(R.string.parakeet_related_alerts));
        map.put(REMINDER_CHANNEL, BackgroundClass.getAppContext().getString(R.string.reminders));
        map.put(BG_ALERT_CHANNEL, BackgroundClass.getAppContext().getString(R.string.glucose_alerts_settings));
        map.put(BG_MISSED_ALERT_CHANNEL, BackgroundClass.getAppContext().getString(R.string.missed_reading_alert));
        map.put(BG_RISE_DROP_CHANNEL, BackgroundClass.getAppContext().getString(R.string.bg_rising_fast));
        map.put(BG_PREDICTED_LOW_CHANNEL, BackgroundClass.getAppContext().getString(R.string.low_predicted));
        map.put(BG_PERSISTENT_HIGH_CHANNEL, BackgroundClass.getAppContext().getString(R.string.persistent_high_alert));
        map.put(CALIBRATION_CHANNEL, BackgroundClass.getAppContext().getString(R.string.calibration_alerts));
        map.put(ONGOING_CHANNEL, "Ongoing Notification");
    }


    private static NotificationManager getNotifManager() {
        return (NotificationManager) BackgroundClass.getAppContext().getSystemService(Context.NOTIFICATION_SERVICE);
    }
